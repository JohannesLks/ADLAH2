...
########################## CONFIGURATION ##########################
## Only in this section changes are deployed (global configuration variables beginning with ""), thus for configuration purposes ;-)
## Timing
TIME_HEARTBEAT = 300
...
CHECK_LISTNERS = True
#Whitelist of ports on which listners are deployed, empty to prevent alerts and set it to informational ("None")
WHITELISTED_PORTS = [
    22,        # ← sshd
    65535,     # ← tcp_ip_port_mon
    53,        # ← DNS
    64295,     # ssh
    20201,     # ← optionaler Port, je nach Setup
    20202
]
